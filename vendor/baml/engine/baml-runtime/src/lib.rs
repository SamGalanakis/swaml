...
#[cfg(all(not(target_arch = "wasm32"), not(feature = "ffi-only")))]
pub mod cli;
...
impl BamlRuntime {
    ...
    #[cfg(all(not(target_arch = "wasm32"), feature = "sdk-generation"))]
    fn generate_client(
        &self,
...
impl BamlRuntime {
    ...
    pub fn run_codegen(
        ...
        strip_tests: bool,
    ) -> Result<Vec<generators_lib::GenerateOutput>> {
